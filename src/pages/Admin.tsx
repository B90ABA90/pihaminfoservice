          ...
          <TabsContent value="sections" className="space-y-6">
            <Tabs defaultValue="hero" className="space-y-4">
              <TabsList className="flex-wrap h-auto">
                ...
                <TabsTrigger value="showcase">Nos réalisations</TabsTrigger>
                <TabsTrigger value="service_btp">Galerie BTP</TabsTrigger>
                <TabsTrigger value="service_cablage">Galerie Câblage</TabsTrigger>
                <TabsTrigger value="service_cctv">Galerie CCTV</TabsTrigger>
                <TabsTrigger value="service_incendie">Galerie Incendie</TabsTrigger>
                <TabsTrigger value="service_fournitures">Galerie Fournitures</TabsTrigger>
              </TabsList>
                ...
                <TabsContent key={sec} value={sec}>
                  <SectionEditor
                    ...
                    deleteKey={async (key) => {
                      const row = contents.find((c) => c.key === key);
                      if (row) {
                        await supabase.from("site_content").delete().eq("id", row.id);
                        await log("delete_content", "content", key);
                        await refreshContent();
                        load();
                      }
                    }}
